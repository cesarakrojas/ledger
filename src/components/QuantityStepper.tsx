  ...
  return (
    <div className="flex items-center gap-0">
      ...
      <button
        ...
        className="w-10 h-10 flex items-center justify-center bg-slate-200 dark:bg-slate-600 hover:bg-slate-300 dark:hover:bg-slate-500 rounded-xl disabled:opacity-50 transition text-lg font-bold"
      >
        −
      </button>
      ...
      <button
        ...
        className="w-10 h-10 flex items-center justify-center bg-emerald-500 dark:bg-emerald-600 hover:bg-emerald-600 dark:hover:bg-emerald-700 text-white rounded-xl disabled:opacity-50 transition text-lg font-bold"
      >
        +
      </button>
    </div>
