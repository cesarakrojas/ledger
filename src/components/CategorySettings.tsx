...
export const CategorySettings: React.FC<CategorySettingsProps> = ({
  ...
  // Toggle enabled with change tracking
      ...
      <div className={SETTINGS_SECTION}>
        ...
        <div className="mt-2 flex items-center gap-2">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Los cambios de moneda se aplican automáticamente
          </p>
        </div>
      </div>
        ...
        <div className="fixed bottom-20 left-0 right-0 px-4 z-40">
          <div className="max-w-7xl mx-auto">
            <button
              ...
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-xl shadow-lg shadow-emerald-500/30 transition-all flex items-center justify-center gap-2"
            >
