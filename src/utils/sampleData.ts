...
export const populateSampleData = async () => {
  ...
  const transactions = [
    ...
    { 
      ...
      description: 'Ingreso: Camiseta Estampada x2', 
      amount: 50.00, 
      category: 'Ventas', 
    ...
    { 
      type: 'inflow' as const, 
      description: 'Ingreso: Zapatillas Deportivas', 
      amount: 65.00, 
      category: 'Ventas', 
    ...
    { 
      type: 'inflow' as const, 
      description: 'Ingreso: Pantalón Casual', 
      amount: 45.00, 
      category: 'Ventas', 
    ...
    { 
      type: 'inflow' as const, 
      description: 'Ingreso: 2 productos', 
      amount: 90.00, 
      category: 'Ventas', 
      paymentMethod: 'Efectivo', 
      daysAgo: 1,
    ...
    { 
      type: 'inflow' as const, 
      description: 'Ingreso: Chaqueta Urbana', 
      amount: 85.00, 
      category: 'Ventas', 
      paymentMethod: 'Tarjeta', 
      daysAgo: 2,
    ...
    { 
      type: 'inflow' as const, 
      description: 'Ingreso: 3 productos', 
      amount: 135.00, 
      category: 'Ventas', 
      paymentMethod: 'Efectivo', 
      daysAgo: 2,
    ...
    { 
      type: 'inflow' as const, 
      description: 'Ingreso: Zapatillas Deportivas x2', 
      amount: 130.00, 
      category: 'Ventas', 
      paymentMethod: 'Transferencia', 
      daysAgo: 3,
  ...
  const debts = [
    // Por Cobrar (Receivables)
    {
      ...
      amount: 450.00,
      description: 'Ingreso al por mayor - 15 prendas varias',
      daysFromNow: 15,
